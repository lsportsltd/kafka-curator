...
using SaslMechanism = KafkaCurator.Abstractions.Configuration.SaslMechanism;
using SecurityProtocol = KafkaCurator.Abstractions.Configuration.SecurityProtocol;
using SslEndpointIdentificationAlgorithm = KafkaCurator.Abstractions.Configuration.SslEndpointIdentificationAlgorithm;
...
namespace KafkaCurator.Extensions
{
    public static class ConfigurationExtensions
    {
        ...
        public static void ReadSecurityInformation(this AdminClientConfig config, ClusterConfiguration cluster)
        {
